...
namespace MazeGenerator
{
    public class CellsBuilder : MonoBehaviour
    {
        ...
        [Range(2, 50)] private int _mazeWidth = 10;
        [Range(2, 50)] private int _mazeHeight = 10;
        ...
        [SerializeField] GameObject _cellPrefab = null;
        ...
        void Awake()
        {
            _mazeHeight = config.mazeHeight ;
            _mazeWidth = config.mazeWidth;
        ...
        private void BuildCell(ref int cellsNum, float x, int i, ref float z, int j)
        {
            ...
            Cells[cellsNum].Model = Instantiate(_cellPrefab);
